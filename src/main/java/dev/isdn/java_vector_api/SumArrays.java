...
public class SumArrays {
    ...
    public static long[] scalarLongSum(long[] a, long[] b) {
        int length = Math.min(a.length, b.length);
        return LongStream.range(0, length).map(i -> a[(int)i] + b[(int)i]).toArray();
    }

    public static long[] vectorApiLongSum(long[] a, long[] b) {
        int length = Math.min(a.length, b.length);
    ...
    public static double[] scalarDoubleSum(double[] a, double[] b) {
        int length = Math.min(a.length, b.length);
    ...
    public static double[] vectorApiDoubleSum(double[] a, double[] b) {
        int length = Math.min(a.length, b.length);
